...
public record AuthResponse(
    @Schema(description = "Short-lived JWT used to authenticate subsequent requests. Include in the Authorization header as: Bearer {token}.")
    String accessToken,
    @Schema(description = "Unique identifier of the authenticated user.")
    String userId,
    @Schema(description = "Display name shown on the user's profile.")
    String displayName,
